  ...
  (0, _createClass3["default"])(Animate, [
    ...
    },
    {
      ...
      value: function UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (showProp) {
          currentChildren.forEach(function(currentChild) {
            ...
            if (
              ...
              newChild = _react2["default"].cloneElement(
                nextChild || currentChild,
                (0, _defineProperty3["default"])({}, showProp, true)
              );
            } else {
              newChild = nextChild;
            }
        ...
        nextChildren.forEach(function(child) {
          ...
          var hasPrev =
            child &&
            (0, _ChildrenUtils.findChildInChildrenByKey)(currentChildren, key);
          if (showProp) {
            var showInNext = child.props[showProp];
            if (hasPrev) {
              var showInNow = (0, _ChildrenUtils.findShownChildInChildrenByKey)(
                currentChildren,
                key,
                showProp
              );
        ...
        currentChildren.forEach(function(child) {
          ...
          var hasNext =
            child &&
            (0, _ChildrenUtils.findChildInChildrenByKey)(nextChildren, key);
          if (showProp) {
            var showInNow = child.props[showProp];
            if (hasNext) {
              var showInNext = (0,
              _ChildrenUtils.findShownChildInChildrenByKey)(
                nextChildren,
                key,
                showProp
              );
    ...
    },
    {
      ...
      value: function isValidChildByKey(currentChildren, key) {
        var showProp = this.props.showProp;
        if (showProp) {
          return (0, _ChildrenUtils.findShownChildInChildrenByKey)(
            currentChildren,
            key,
            showProp
          );
        }
        return (0, _ChildrenUtils.findChildInChildrenByKey)(
          currentChildren,
          key
        );
      }
...
Animate.propTypes = {
  ...
  transitionName: _propTypes2["default"].oneOfType([
